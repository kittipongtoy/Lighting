...
namespace Lighting.Controllers.Backend
{
    public class ManageSmartSolutionController : Controller
    {
        ...
        //public async Task<IActionResult> Add_Category([FromForm] Input_Smart_Solution_CategoryVM input)
        //{
        //    if (ModelState.IsValid)
        //    {
        //        try
        //        {
        //            var newFileName = Guid.NewGuid().ToString().Substring(0, 6) + ".jpg";
        //            var path = Path.Combine("upload_image", "Smart_Solution", newFileName);
        ...
        //            await _db.Smart_Solution_Categorys
        //                .AddAsync(
        //                new Smart_Solution_Category
        //                {
        //                    PreviewImg = path,
        //                    CategoryName_EN = input.CategoryName_EN,
        //                    CategoryName_TH = input.CategoryName_TH,
        //                });
        ...
        //{
        //    var category = _db.Smart_Solution_Categorys.Where(x => x.Id == id).FirstOrDefault();
        //    if (category != null)
        //    {
        //        var path = Path.Combine(_env.WebRootPath, category.PreviewImg);
        //        if (System.IO.File.Exists(path))
        //        {
        //            System.IO.File.Delete(path);
        //        }
        //        _db.Smart_Solution_Categorys.Remove(category);
        //        await _db.SaveChangesAsync();
        //        return Json(new { status = "success", message = "ลบข้อมูลเรียบร้อย" });
        //    }
        //    return Json(new { status = "error", message = "ไม่พบข้อมูล" });
        //}
        //public async Task<IActionResult> Edit_Category([FromForm] Input_Smart_Solution_CategoryVM input, [FromQuery] int id)
        //{
        //    try
        //    {
        //        var newFileName = Guid.NewGuid().ToString().Substring(0, 6) + ".jpg";
        //        var path = Path.Combine("upload_image", "Smart_Solution", newFileName);
        //        var slc = await _db.Smart_Solution_Categorys.FirstOrDefaultAsync(slc => slc.Id == id);
        //        if (slc != null)
        //        {
        //            if (input.PreviewImg != null)
        //            {
        //                var oldFile = Path.Combine(_env.WebRootPath, slc.PreviewImg);
        ...
        //                slc.PreviewImg = path;
        //            }
        //            slc.CategoryName_EN = input.CategoryName_EN;
        //            slc.CategoryName_TH = input.CategoryName_TH;
        //            await _db.SaveChangesAsync();
        //            return Json(new { status = "success", message = "บันทึกข้อมูลเรียบร้อย" });
        //        }
        //        return Json(new { status = "error", message = "ไม่พบข้อมูล" });
        ...
        //    }
        //}
        //public async Task<IActionResult> Manage_Category_Page()
        //{
        //    var category = await _db.Smart_Solution_Categorys.OrderByDescending(cate => cate.Id).ToListAsync();
